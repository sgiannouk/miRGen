"""
Django settings for mirgen_site project.
...
SECRET_KEY = 'django-insecure-#a)5-_rz6nrwj16$3@v(onpe6-04sa!+n=a=!ruv2557%$q^*w'
...
WSGI_APPLICATION = 'mirgen_site.wsgi.application'
